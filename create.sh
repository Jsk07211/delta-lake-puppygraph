...
# Inside Docker network, you'd typically use:
# UC_SERVER="${UC_SERVER:-http://unitycatalog:8080}"

CATALOG="${CATALOG:-puppygraph}"
SCHEMA="${SCHEMA:-demo}"

# This must be a path that Spark + PuppyGraph can read (in Docker, usually file:///delta/demo)
