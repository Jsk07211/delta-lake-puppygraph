...
INSERT OVERWRITE puppygraph.demo.Users
SELECT
...
INSERT OVERWRITE delta.puppygraph.demo.UserInternetGatewayAccess
SELECT
  user_id,
  internet_gateway_id,
  access_level,
...
-- PRIVATE IPS
CREATE TABLE IF NOT EXISTS pdelta.`/delta/demo/PrivateIPs` (
